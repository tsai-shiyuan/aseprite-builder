...
Open `Aseprite.app`. If you see the error: 

```bash
"Aseprite.app is damaged and can’t be opened"
```

This is caused by macOS Gatekeeper, run the following command:

```bash
xattr -dr com.apple.quarantine <Path>/Aseprite.app
```

Aseprite is now running successfully. 🥳
